...
@Component({
  ...
  template: `
    <mat-card-title class="d-flex flex-row">
      <button routerLink="/store/categories/create" color="primary" class="ft-button" mat-flat-button>
        Add Category
      </button>
...
export class CategoriesComponent implements OnInit {
  ...
  editCategory(element: CategoryModel): void {
    ...
    this.router.navigateByUrl('/store/categories/edit/' + element.id).catch(_ => {
    });
  }
