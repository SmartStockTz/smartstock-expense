    ...
    <div>
      <div mat-dialog-title>
        <div style="display: flex; flex-direction: row; flex-wrap: nowrap">
          ...
          <button [disabled]="(stockState.isFetchStores | async)===true" (click)="getProducts()" mat-flat-button
                  color="primary" style="flex-grow: 0">
            <mat-icon *ngIf="(stockState.isFetchStores | async)===false">refresh</mat-icon>
      ...
      <div mat-dialog-content>
        <cdk-virtual-scroll-viewport [itemSize]="50" style="height: 300px">
          <div *cdkVirtualFor="let product of stockState.storeItems | async">
            <div style="display: flex; flex-direction: row; flex-wrap: nowrap">
...
export class ProductSearchDialogComponent implements OnInit {
  ...
  selectProduct(product: StoreModel): void {
