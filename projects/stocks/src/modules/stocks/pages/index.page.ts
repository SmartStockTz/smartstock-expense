...
<!--          <div class="d-flex flex-row flex-wrap">-->
<!--&lt;!&ndash;            <div class="container-fluid row" style="width: 100%">&ndash;&gt;-->
<!--              <app-total-products-summary class="my-2 col-sm-11 col-md-6 col-lg-6 col-xl-6">-->
<!--              </app-total-products-summary>-->
<!--              <app-products-value-summary class="col-sm-11 col-md-6 col-lg-6 col-xl-6 my-2">-->
